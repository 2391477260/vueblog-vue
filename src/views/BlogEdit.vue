        ...
        <div class="m-content">
            <el-form ref="editForm" status-icon :model="editForm" :rules="rules" label-width="80px">
                ...
                <el-form-item>
                    ...
                    <el-button type="primary" @click="returnblogs()">取消</el-button>
                    <el-button @click="DeleteBlog()">删除该博客</el-button>
                </el-form-item>
            </el-form>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            DeleteBlog(){
                const blogId = this.$route.params.blogId
                const _this = this
                this.$axios.delete("/deleteBlog/" + blogId,{headers: {
                        "Authorization": localStorage.getItem("token")
                    }}).then((res) => {
                        _this.$alert('删除成功', '提示', {
                        confirmButtonText: '确定',
